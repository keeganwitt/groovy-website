...
Groovy 6 ships seven new optional modules, plus a long-standing piece
of core (Grape's Ivy backend) split out into its own module:
...
See the https://docs.groovy-lang.org/docs/latest/html/documentation/using-ginq.html[GINQ user guide]
...
See the https://docs.groovy-lang.org/docs/latest/html/documentation/processing-csv.html[Processing CSV user guide]
...
See the https://docs.groovy-lang.org/docs/latest/html/documentation/processing-markdown.html[Processing Markdown user guide]
...
See the https://docs.groovy-lang.org/docs/latest/html/documentation/grape.html[Grape user guide]
