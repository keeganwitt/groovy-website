...
NOTE: This section is still under development and is subject to change or movement to another Groovy version. The final details of the Grape dual engine support may differ from what is described here.
...
- In most cases, switching from GrapeMaven to GrapeIvy is straightforward. GrapeIvy's defaults are more permissive, so scripts that work with GrapeMaven typically work unchanged with GrapeIvy.
