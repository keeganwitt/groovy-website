...
link:https://openjdk.org/jeps/405[JEP 405: Record Patterns & Array Patterns (Preview)]
link:https://openjdk.org/jeps/406[JEP 406: Pattern Matching for switch (Preview)]
