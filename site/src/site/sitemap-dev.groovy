...
downloads {
    distribution('Groovy 6.0') {
        ...
        version('6.0.0-alpha-2') {
            stable false
//            windowsInstaller 'https://groovy.jfrog.io/artifactory/dist-release-local/groovy-windows-installer/groovy-6.0.0-alpha-2/'
        }
    ...
    distribution('Groovy 5.0') {
        ...
        version('5.0.7') {
            stable true
//            windowsInstaller 'https://groovy.jfrog.io/artifactory/dist-release-local/groovy-windows-installer/groovy-5.0.7/'
        }
        version('5.0.6') {
            stable true
            archive true
    ...
    distribution('Groovy 4.0') {
        ...
        version('4.0.33') {
            stable true
//            windowsInstaller 'https://groovy.jfrog.io/artifactory/dist-release-local/groovy-windows-installer/groovy-4.0.33/'
        }
        version('4.0.32') {
            stable true
            archive true
