...
for a 0-day vulnerability. Details can be found on https://groovy-lang.org/security.html
...
Changelog for this version can be found at: https://groovy-lang.org/changelogs/changelog-2.4.6.html
