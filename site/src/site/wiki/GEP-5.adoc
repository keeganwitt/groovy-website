...
*Type*:: Feature
*Status*:: Rejected
*Comment*:: Groovy 1.8 instead adopted a general compiler configuration mechanism
...
https://marc.info/?l=groovy-dev&m=126725425413269&w=2[groovy-dev: GEP 5 - file extension based AST transformations]
