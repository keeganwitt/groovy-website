...
This GEP composes with several other in-flight features:

* <<gep-23,GEP-23>> (DO and `MonadicChecker`) — `Result<T>` is a new entry
in the same registry; depends on GEP-23 landing first.
