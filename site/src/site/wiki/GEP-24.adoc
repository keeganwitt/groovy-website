...
* https://github.com/functionaljava/functionaljava[FunctionalJava] — `fj.data.Validation` lineage
...
* https://joeduffyblog.com/2016/02/07/the-error-model/[Joe Duffy — "The Error Model"] — Midori's hybrid exception/Result design that informs the spec-layer / carrier-layer split
