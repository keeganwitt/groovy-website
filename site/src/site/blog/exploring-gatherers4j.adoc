...
:description: This post looks at using Gatherers4J (relies on JDK24 stream gatherer API) with Groovy.
...
image:img/collate.png[collate a list - produced by Dall-E 3,200,float='right']== Revisiting Collate with Gatherers4J
