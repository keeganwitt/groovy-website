...
[Sorry U.S. readers, _Autumn_ has the same number of letters as the other season names
...
The `inverse` method is available on `ImmutableListMultimap` and `ImmutableSetMultimap` instances;
