...
https://github.com/paulk-asert/groovy-verify/blob/main/examples/miscellaneous.md[`groovy-verify`]
...
* The https://github.com/paulk-asert/groovy-verify/blob/main/examples/miscellaneous.md[`groovy-verify`] FizzBuzz example and its Concurrency "lite" section
