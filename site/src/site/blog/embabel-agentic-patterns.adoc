...
as the Python of the JVM world. It's syntax mostly resembles Java but some of its features
...
We'll create a `@SumType` AST transform (details in the source code repo). Then our code becomes:
