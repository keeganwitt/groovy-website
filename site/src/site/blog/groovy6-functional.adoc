...
class WordCountPrimitives {
    ...
    static Map<String, ?> countWords(String text) { [words: text.split(/\s+/).findAll{ it }.size()] }

    @Wirable(inputs = ['text'], outputs = ['lines'])
    static Map<String, ?> countLines(String text) { [lines: text.readLines().size()] }
...
* https://github.com/paulk-asert/groovy6-functional[Companion code for this post] — see the
