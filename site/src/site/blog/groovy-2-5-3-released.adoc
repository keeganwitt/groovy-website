...
The Apache Groovy team is pleased to announce version 2.5.3 of Apache Groovy. Apache Groovy is a multi-facet programming language for the JVM. Further details can be found at the https://groovy.apache.org website.
...
Sources, convenience binaries, downloadable documentation and an SDK bundle can be found at: https://www.groovy-lang.org/download.html
...
For more information on how to report problems, and to get involved, visit the https://groovy.apache.org/[project website].
