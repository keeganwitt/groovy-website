...
Underdog sits on top of some well-known data-science libraries like Smile and Tablesaw, so
if you have used either of those libraries, you'll recognise parts of the functionality.
