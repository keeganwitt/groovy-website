...
https://communityovercode.org/past-sessions/community-over-code-na-2023/[schedule].
...
* https://communityovercode.org/past-sessions/community-over-code-na-2023/[The official schedule] includes all tracks and will include
links to the slides of the talks if/when available.
* Details for https://communityovercode.org/[Community over Code EU] next year.