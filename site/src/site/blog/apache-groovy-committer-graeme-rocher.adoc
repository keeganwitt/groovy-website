= Apache Groovy&trade; committer Graeme Rocher receives Oracle Groundbreaker award
Paul King
...
The https://groovy.apache.org/[Apache Groovy] team congratulates long-time Groovy committer
