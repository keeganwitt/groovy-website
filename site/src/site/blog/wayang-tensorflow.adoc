...
:updated: 2025-08-28T14:21:00+00:00
...
image:img/iris_flowers.png[iris flowers,180,float="right"]In previous blog posts, we have looked at:
...
> image:https://www.apache.org/logos/res/wayang/default.png[wayang logo,140,float="right"]
...
Operators are the chunks of work that can be allocated to our processing platform.
