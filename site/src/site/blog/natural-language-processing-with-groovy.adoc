= Natural Language Processing with Groovy&trade;, OpenNLP, CoreNLP, Nlp4j, Datumbox, Smile, Spark NLP, DJL and TensorFlow
Paul King
...
This example is inspired from the https://github.com/deepjavalibrary/djl/blob/master/examples/src/main/java/ai/djl/examples/inference/nlp/UniversalSentenceEncoder.java[UniversalSentenceEncoder] example in the
