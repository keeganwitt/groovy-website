...
:description: Groovy 6's stance on functional programming — same starting point as Java, but with checked algebra (Monoid/Semigroup), verified purity, monadic comprehensions, and machine-actionable annotations.
