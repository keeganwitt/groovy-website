...
in <<_example_6_the_raid_party_structured_concurrency_with_asyncscope, Example 6>>.
...
[source,groovy]
----
var loot = await Awaitable.completeOnTimeout(raidDungeon(heroes, rooms), [], 30, SECONDS)
----
