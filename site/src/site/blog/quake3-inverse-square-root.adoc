...
https://web.archive.org/web/20250207183256/https://suraj.sh/fast-square-root-approximation[Fast Square Root Approximation]
and
...
* https://web.archive.org/web/20221221151427/https://www.slideshare.net/maksym_zavershynskyi/fast-inverse-square-root[Behind the Performance of Quake 3 Engine: Fast Inverse Square Root]